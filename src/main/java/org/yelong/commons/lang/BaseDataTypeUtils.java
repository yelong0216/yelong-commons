...
public final class BaseDataTypeUtils {
	 ...
	 * 基础数据类型
	 */
	private static final List<String> BASE_DATA_TYPE = Arrays.asList("byte","short","int","long","float","double","boolean","char");
	
	/**
	 * 包装数据类型
	 */
	private static final List<Class<?>> BASE_DATA_WRAPPER_TYPE =  Arrays.asList(Byte.class,Short.class,Integer.class,Long.class,Float.class,Double.class,Boolean.class,Character.class);
